			...
			<table id="qna_box">
				<colgroup>
					...
					<tr id="qna_tr_title">
						...
						<td>
							<div class="qna_content" id="q_qna_title"><input type="text" value="${q.qna_title}" name="qna_title" style="height: 25px; width: 340px;"></div>
						</td>
					</tr>
					...
					<tr id="qna_tr_no">
						...
						<td>
							<div class="qna_content" id="q_detail_no_update">${q.detail_no}<input value="${q.detail_no}" type="hidden" name="detail_no" style="height: 25px; width: 100px;"></div>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<div class="qna_content" id="q_qna_content"><textarea name="qna_content" rows="10" cols="50">${q.qna_content }</textarea></div>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<div class="qna_content" id="q_qna_img"><input type="hidden" name="qna_img" value="${q.qna_img }">
				...
				<a id="delete" href="deleteQna?qna_no=${q.qna_no }">삭제</a>
				<div id="update">
